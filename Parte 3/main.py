...
import semantico.semantico as sm
import time
...
if __name__ == "__main__":
    ...
    tempo_semantico = time.time()
    sm.semantico(lista_tokens)
    tempo_semantico = time.time() - tempo_semantico
    ...
    #console.print(f"Tempo gasto no analisador semântico: {tempo_semantico} s", style="bold green")
    #print("\n")
